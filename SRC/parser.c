...
/*   Updated: 2023/08/03 19:59:31 by jareste-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	dsttodot(char *str, char dot)
{
	int	i;
...
static int	do_dots(t_tokens *tokens, char *str)
{
	int	len;

	len = dsttodot(str, str[0]);
	// printf("%i %c str::%s\n", len, str[0], str + 1);
	if (str[0] == '"')
